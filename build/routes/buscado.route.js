...
buscadoRoute.get('/buscados', auth_1.authorize, buscado_service_1.getBuscados);
buscadoRoute.get('/buscados/:id', buscado_service_1.getByIdBuscados);
buscadoRoute.post('/buscados', uploadHelper_1.default.single('image'), buscado_validator_1.validateCreate, buscado_service_1.postBuscados);
buscadoRoute.put('/buscados/:id', buscado_validator_1.valiteUpdate, buscado_service_1.putBuscados);
